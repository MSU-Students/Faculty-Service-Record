<template>
  <q-page class="bg-blue-1">
    <div class="q-pa-md">
      ...
      <div class="text-h6 q-pb-md">Department: Computer Science</div>
      <br />
      <div class="q-gutter-sm row">
        <div class="text-h6 q-pr-lg">Month: September</div>
        <div class="text-h6 q-px-xl">Year: 2021</div>
      </div>
      <div class="q-pt-md">
        <q-table
          separator="cell"
        ...
        >
          <template v-slot:body="props">
            <q-tr :props="props">
              ...
              <q-td
                key="absent_onleave_officialbusiness_undertime"
                :props="props"
              >
      ...
      <div class="text-h6 q-pa-md row">TOTAL OF HOURS: 60</div>
      <q-btn
        icon="logout"
        label="Logout"
        class="float-right q-mx-xl"
...
const rows = [
  {
    ...
    name: 'Monday',
    instruction_class: '8',
    consultation_activities: '5',
    community_institutional: '8',
    hours: '8',
    absent_onleave_officialbusiness_undertime: '8',
  },
  {
    no: 2,
    name: 'Tuesday',
    instruction_class: '4',
    consultation_activities: '8',
    community_institutional: '3',
    hours: '8',
    absent_onleave_officialbusiness_undertime: '6',
  },
  {
    no: 3,
    name: 'Wednesday',
    instruction_class: '5',
    consultation_activities: '2',
    community_institutional: '5',
    hours: '8',
    absent_onleave_officialbusiness_undertime: '5',
  },
  {
    no: 4,
    name: 'Thursday',
